    ...
    <b-row>
        <b-colxx xxs="12">
            ...
            <div class="top-right-button-container">
                ...
                >
                <!-- <b-button-group>
          <select name="" class="form-control" @change="selectRole(seleced_role)" v-model="seleced_role"  >
              <option value="">Select Role</option>
              <option v-for="(role, ind) in rolesList" :value="role"   >{{role.label}}</option>
          </select>
        </b-button-group> -->
            </div>
            <add-new-modal
...
export default {
    ...
    methods: {
        gotoAddUser() {
            this.$router.push(`${adminRoot}/user/add`);
        },
    },
    computed: {
