      ...
      <b-card class="mb-4" :title="$t('forms.basic')">
        ...
        >
          ...
          <b-form-group label="Custom Radio Buttons" class="error-l-150">
            <b-form-radio-group stacked v-model.trim="$v.customRadio.$model">
              <b-form-radio value="first"
                >Select this custom radio</b-form-radio
              >
              <b-form-radio value="second">Or this one</b-form-radio>
              <b-form-radio value="third"
                >But not this disabled one</b-form-radio
              >
            </b-form-radio-group>
            <b-form-invalid-feedback
              class="d-block"
          ...
          <b-form-group label="Custom Checkboxes" class="error-l-150">
            ...
            <b-form-invalid-feedback
              class="d-block"
              v-if="!$v.customCheckbox.required && $v.customCheckbox.$dirty"
              >Please select one!</b-form-invalid-feedback
            >
          </b-form-group>
