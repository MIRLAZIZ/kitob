                ...
                axios
                    ...
                    .then((response) => {
                        if (response.data.error) {
                            ...
                            localStorage.setItem("admin_state", JSON.stringify({ rules: this.state.rules }));
                            //localStorage.setItem("admin_state", localStorage.getItem('state'));
                            localStorage.setItem("admin_user", JSON.stringify(this.state.currentUser));
