...
const actions = {
    ...
    async searchBookAutocomplete({ commit }, query) {
        await axios
            .get(`/api/book/public-search?name=${query.name}`)
            .then((r) => r.data)
            .then((res) => {
    ...
    async updateBook({ commit }, book) {
        await axios
            .post(`/api/book/update/${book.id}`, book)
            .then((r) => r.data)
            .then((res) => {
    ...
    async addTranslation({ commit }, book) {
        await axios
            .post(`/api/book/add-translation`, book)
            .then((r) => r.data)
            .then((res) => {
                commit("updateTheBook", res);
            });
    ...
    async destroyEpub({ commit }, path) {
        await axios
            .post(`/api/book/epub/destroy`, { 'path': path })
            .then((r) => r.data)
            .then((res) => {
                commit("updateTheBook", res);
            });
    ...
    async removeAudioById({ commit }, mp3id) {
        await axios
            .delete(`/api/book/audio/remove/${mp3id}`)
            .then((r) => r.data)
            .then((res) => {
                if (res.success) {
                    commit("setBookAudio", res.result);
