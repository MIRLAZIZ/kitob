...
import SeriesListPageHeading from "./SeriesListPageHeading";
import SeriesListPageListing from "./SeriesListPageListing";

export default {
  components: {
    "list-page-heading": SeriesListPageHeading,
    "list-page-listing": SeriesListPageListing
  },
  data() {
    return {
      isLoad: false,
  ...
  methods: {
    ...mapActions(['getSeriesList','destroyTcategory']),
  ...
  computed: {
    ...mapGetters(['seriesList','getSeriesAlertMsg']),
    isSelectedAll() {
  ...
  async mounted() {
    ...
    this.total = this.seriesList.result.total;
    this.from = this.seriesList.result.from;
    this.to = this.seriesList.result.to;
    this.items = this.seriesList.result.data.map(x => {
    return {
        ...x,
        img: x.photo
    };
    });
    this.perPage = this.seriesList.result.per_page;
    this.selectedItems = [];
    this.lastPage = this.seriesList.result.last_page;
    this.isLoad = true;
  }
};
</script>