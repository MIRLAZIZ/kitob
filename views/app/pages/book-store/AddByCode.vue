        ...
        <b-colxx xxs="12">
            <b-card class="mb-4" title="Barcode">
                ...
                <b-card>
                    ...
                    <Items v-for="(theBook,index) in books" :key="index" :index="index" :book="theBook" @updateParentBooks="updateBooks" />
...
export default {
    ...
    computed: {
        ...mapGetters(["getBooktypeAlertMsg","bookListArray","getEpubContent","getTheBook"]),
        totalPriceAndQty(){
            var qty = 0;
            var price = 0;
    ...
    methods: {
        ...mapActions(['addBooktypeByArray','getBookListArray','storeEpub','getBookByBarCode']),
        ...
        async onFormSubmit(){
            ...
            await this.addBooktypeByArray(form);
        ...
        findBookByBarcode(barcode){
            ...
            return this.books.findIndex(item => item.isbn === isbn);
        },
