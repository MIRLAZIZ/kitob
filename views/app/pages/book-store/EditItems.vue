    ...
    <div class="sard card mb-3" v-if="book">
        <div class="card-body d-flex align-items-center justify-content-between">
            <div class="form-group w-40">
                ...
                <h6 class="text-dark mb-0">{{book.book ? book.book.name : book.name}}</h6>
                <p class="text-muted text-small mb-0" v-if="book.book">({{book.book.author.length ? book.book.author[0].fio : ''}})</p>
            </div>
