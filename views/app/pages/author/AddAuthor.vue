          ...
          <b-form @submit.prevent="onaddAuthorFormSubmit">
            <div class="alerts" v-if="errorMsgs">
              <div class="alert alert-danger">
                <template v-for="err in errorMsgs"> {{ err[0] }}</template>
              </div>
            </div>
            ...
            <label class="form-group has-float-label">
              <input
                type="date"
                class="form-control"
                v-model="addAuthorForm.birthday"
                required
              />
            ...
            <label class="form-group has-float-label">
              <input
                type="date"
                class="form-control"
                v-model="addAuthorForm.death_day"             
              />
            ...
            <label class="form-group has-float-label">
              <textarea
                ...
                rows="4"
                class="form-control"
                v-model="addAuthorForm.description"
              ></textarea>
