...
export default {
  ...
  computed: {
    ...mapGetters(['invoicesList','getUzcardAlertMsg']),
    isSelectedAll() {
  ...
  async mounted() {
    ...
    //if(this.getUzcardAlertMsg.success){
        this.total = this.invoicesList.total;
        this.from = this.invoicesList.from;
        this.to = this.invoicesList.to;
        this.items = this.invoicesList.data.map(x => {
            return {
                ...x,
                img: x.photo
            };
        });
        this.perPage = this.invoicesList.per_page;
        this.selectedItems = [];
        this.lastPage = this.invoicesList.last_page;
        this.isLoad = true;
    //}
  }
};
