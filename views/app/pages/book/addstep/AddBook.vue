  ...
  <b-card>
    ...
    <b-form v-if="steps[0].status === 'current'" @submit.prevent="submitfirst">
      ...
      <b-form-group :label="$t('forms.title')">
        <b-form-input
          type="text"
          v-model="$v.firststep.name.$model"
      ...
      <b-form-group :label="$t('forms.subtitle')">
        <b-form-input
          type="text"
          v-model="$v.firststep.subtitle.$model"
      ...
      <b-form-group :label="$t('forms.edition')">
        <b-form-input
          type="number"
          v-model="$v.firststep.edition.$model"
          :placeholder="$t('forms.edition')"
        />
      </b-form-group>
      <div class="col-md-12 mb-4">
        <label class="form-group has-float-label">
          <v-select
            ...
            v-model="$v.firststep.author.$model"
      ...
      <b-form-group :label="$t('survey.category')">
        <treeselect
          v-if="categoryListArray"
          v-model="$v.firststep.category.$model"
          :multiple="true"
      ...
      <b-form-group :label="$t('book.description')">
        <b-form-input
          type="text"
          v-model="$v.firststep.description.$model"
      ...
      <b-form-group :label="$t('book.year')">
        <b-form-input
          type="text"
          v-model="$v.firststep.year.$model"
      ...
      <div class="col-sm-4 mb-4">
        ...
        <div class="p-4 border mt-4">
          ...
          <div class="btn-group m-3 text-center d-flex">
            ...
            <label class="btn btn-danger btn-xs">{{ $t("book.delete") }}</label>
          </div>
        </div>
      </div>
      <b-form-group :label="$t('book.age_access')">
        <b-form-input
          type="text"
          v-model="$v.firststep.age_access.$model"
    ...
    <b-form v-if="steps[1].status === 'current'" @submit.prevent="submitsecond">
      <div class="alert alert-danger" v-if="secondsteperror">
        You have to fill out all fields...
      </div>
      <b-form-group :label="$t('book.isbn')">
        <b-form-input
          type="text"
          v-model="$v.secondstep.isbn.$model"
          :placeholder="$t('forms.isbn')"
        />
      </b-form-group>
      <b-form-group :label="$t('book.series')">
        <b-form-input
          type="text"
          v-model="$v.secondstep.series.$model"
          :placeholder="$t('forms.series')"
        />
      </b-form-group>
      <b-form-group :label="$t('book.preview')">
        <b-form-input
          type="text"
          v-model="$v.secondstep.preview.$model"
          :placeholder="$t('forms.preview')"
        />
      </b-form-group>
      <div class="col-md-12 mb-5">
        ...
        >
          ...
          <div class="toc_block">
            ...
            <div class="toc_body">
              <TrChild
                v-for="(item, ind) in tocDataList"
                :key="item.id"
                :node="item"
                :tocData="tocData"
                @addChildToc="addChildToc(item)"
                @rmTocItem="rmTocItem(item)"
                :ind="ind"
              />
            </div>
          </div>
