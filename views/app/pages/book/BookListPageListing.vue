...
<script>
import BookImageListItem from "./BookImageListItem";
import BookThumbListItem from "./BookThumbListItem";
import BookDataListItem from "./BookDataListItem";
import { mapActions } from "vuex";
export default {
    components: {
        "image-list-item": BookImageListItem,
        "thumb-list-item": BookThumbListItem,
        "data-list-item": BookDataListItem
    },
    props: [
        "displayMode",
        "items",
