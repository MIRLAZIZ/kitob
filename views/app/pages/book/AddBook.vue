          ...
          <b-form @submit.prevent="onAddBookFormSubmit">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 mb-4">
                    <div class="p-4 border mt-4">
                        <label class="form-group has-float-label jv_input_file_label">
                            <input type="file" class="form-control jv_input_file" @change="setFile($event,'audio')" />
                ...
                <div class="border card col-sm-12 mb-4 pb-4" id="papers">
                    <b-button v-b-toggle.collapseAccordion3 variant="link">Prices</b-button>
                    <b-collapse id="collapseAccordion3" class="mt-4" accordion="my-accordion">
                        <div class="row">
                            <div class="col-md-4">
                                <label class="form-group has-float-label">
