<template>
                    ...
                    <b-form @submit.prevent="onAddBookFormSubmit" v-if="!isLoad">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 mb-4">
                                ...
                                <div class="p-4 border mt-4">
                                    <div class="cover_image">
                                        <img :src="formdata.image" alt="" class="img-fluid" />
                                    </div>
                            ...
                            <div class="col-sm-4 mb-4">
                                <div class="p-4 border mt-4" style="position: relative" v-if="!epubfile">
                                    <label class="form-group has-float-label jv_input_file_label">
                                        <input type="file" class="form-control jv_input_file" @change="
                                            setEpubFile($event, 'ebook')
                                        " />
                          ...
                          <div class="progress_line" :data-pernum="progBarCount+'%'" :style="{width: progBarCount+'%'}"></div>
                                    ...
                                    <b-progress v-if="progBarCount > 0" :value="progBarCount" max="100"
                                        animated></b-progress>
                                </div>
                                <div class="p-4 border mt-4" style="position: relative" v-else>
                                    <label class="form-group has-float-label jv_input_file_label jv_error_btn"
                                        @click="deleteEpub">
                            ...
                            <div class="col-sm-4 mb-4">
                                <div class="p-4 border mt-4">
                                    <div class="audio_wrap" v-if="hasAudio">
                                        <template v-for="(mp3, index) in formdata.audio">
                                            <div class="card p-3 shadow mb-2" :key="index">
                                                <h5 class="text-primary">{{ mp3.song }} / <small class="text-secondary">
                                                        {{ mp3.artist }} </small></h5>
                                    ...
                                    <label class="form-group has-float-label jv_input_file_label">
                                        <input type="file" class="form-control jv_input_file"
                            ...
                            <div class="col-md-12 mb-5">
                                ...
                                <b-modal id="modallong" ref="modallong" :title="$t('book.add_toc')">
                                    ...
                                    <template slot="modal-footer">
                                        <b-button variant="primary" @click="sendToc()" class="mr-1">{{ $t("menu.add")
                                        }}</b-button>
                                    </template>
                                </b-modal>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                <label class="form-group has-float-label">
                                    <v-select multiple :options="authorsListArray" v-model="formdata.author"
                                        :reduce="(option) => option.id" label="fio" />

                                    <span>{{ $t("book.author_id") }}</span>

                                    <button class="btn_add_select" v-b-modal.authormodal variant="outline-primary"
                                        type="button">
    ...
    toolbar:
        'undo redo | formatselect | bold italic | \
                                        ...
                                        <div class="col-md-7">
                                            <label class="form-group has-float-label">
                                                <textarea cols="12" rows="20" class="form-control"
                                        ...
                                        <div class="col-md-5">
                                            <div class="d-flex mb-3">
                                                <div class="col-md-6 custom-control custom-checkbox">
                                                    ...
                                                    " type="checkbox" class="custom-control-input" id="is_new" v-model="
    formdata.is_new
" />
                                                ...
                                                <div class="col-md-6 custom-control custom-checkbox">
                                                    ...
                                                    " type="checkbox" id="is_bestseller" true-value="1" false-value="0"
                                                        class="custom-control-input" v-model="
                                                            formdata.is_bestseller
                                                        " />
                                                    <label class="custom-control-label" for="is_bestseller">{{
                                                            $t(
                                                                "book.is_bestseller"
                                                            )
                                                    }}</label>
                                            ...
                                            <div class="d-flex">
                                                <!-- Status -->
                                                <div class="col-md-4 form-group pl-0" v-if="
...
" />
                                                ...
                                                <div class="col-md-4 form-group pl-0">
                                                    <label class="form-group has-float-label">
                                                        <v-select :options="languages" :dir="direction" @input="
                                                            setSelectedLang
                                                        " v-model="
    selectedLang
" />
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label  for="gallery_image" class="form-group has-float-label m-auto jv_input_file_label">
                                                <input type="file" id="gallery_image" class="form-control jv_input_file" @change="storeToGallery($event, 'ebook')" />
                                                <i class="simple-icon-plus"></i>
                                            </label>
                                        </div>
                                        <hr>
                                        <div class="d-flex align-items-center justify-content-start" v-if="galleries.length">
                                            <b-card class="d-flex flex-row active ml-1" no-body v-for="(gallery,ind) in galleries">
                                                <img :src="gallery.path" class="list-thumbnail responsive border-0" :alt="gallery.id" />
                                            </b-card>
                                        </div>
                                    </div>
                                </b-collapse>
                            ...
                            <!-- ebooks -->
                            <b-modal id="authormodal" ref="modalbasic" :title="$t('modal.modal-title')"
                                :hide-footer="true">
