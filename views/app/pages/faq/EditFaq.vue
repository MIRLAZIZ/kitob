...
export default {
    ...
    computed: {
        ...mapGetters(["getFaqAlertMsg","getCurrentFaq"]),
    },
    methods: {
        ...mapActions(['updateFaq','getTheAFaq']),
        async onFaqFromSubmit() {
            await this.updateFaq(this.faqFrom);
    ...
    async mounted(){
        await this.getTheAFaq(this.$route.params.id)
        this.faqFrom = this.getCurrentFaq;
    }
};
</script>
