                    ...
                    <b-form @submit.prevent="onAddUserFormSubmit">
                        ...
                        <label class="form-group has-float-label">
                            ...
                            <b-form-select
                                ...
                                :state="!$v.userForm.role.$error"
                                text-field="label"
                            />
                            <b-form-invalid-feedback
                                v-if="!$v.userForm.role.required"
                                >Поле, обязательное для
                                заполнения</b-form-invalid-feedback
                            >
...
export default {
    ...
    computed: {
        ...mapGetters(["getUserAlertMsg", "getRoles"])
    },
    async mounted() {
    ...
    methods: {
        ...mapActions(["addUser", "getRolesApi"]),
        async onAddUserFormSubmit() {
            ...
            user.append("role_id", this.userForm.role);
