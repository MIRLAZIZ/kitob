    ...
    <div>
        ...
        <b-row>
            <b-colxx
                ...
                md="6"
                class="mb-4"
                v-if="loadedTopActiveCategories"
            >
                <website-visit-chart-card
        ...
        <b-row>
            <b-colxx
                ...
                md="6"
                class="mb-4"
                v-if="loadedTopActivePublishers"
            >
                <website-visit-chart-card
    ...
    async created() {
        ...
        if (this.dashTopBooksByReview.success == true) {
            if (
                ...
                this.top_books_by_review_data =
                    this.dashTopBooksByReview.result.data;
        ...
        if (this.dashTopBooksByView.success == true) {
            if (
                ...
                this.top_books_by_view_data =
                    this.dashTopBooksByView.result.data;
                this.top_books_by_view_label =
                    this.dashTopBooksByView.result.labels;
        ...
        if (this.dashTopActiveUsers.success == true) {
            if (
                ...
                this.top_active_users_data =
                    this.dashTopActiveUsers.result.data;
                this.top_active_users_label =
                    this.dashTopActiveUsers.result.labels;
        ...
        if (this.dashTopBooksBySale.success == true) {
            if (
                ...
                this.top_books_by_sale_data =
                    this.dashTopBooksBySale.result.data;
                this.top_books_by_sale_label =
                    this.dashTopBooksBySale.result.labels;
